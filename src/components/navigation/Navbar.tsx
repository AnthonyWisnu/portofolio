  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-3 sm:px-8 py-3 sm:py-4 pointer-events-none">
      <div className="max-w-7xl mx-auto flex items-center justify-between pointer-events-auto backdrop-blur-md bg-white/70 dark:bg-neutral-950/70 border border-neutral-200/60 dark:border-neutral-800/60 rounded-full px-3.5 sm:px-5 py-2.5 sm:py-3 shadow-xs">
        ...
        <Link
          href="#hero"
          className="flex items-center gap-2 sm:gap-3 text-sm font-semibold tracking-tight hover:opacity-80 transition-opacity"
        >
          <span className="w-2.5 h-2.5 rounded-full bg-red-600 shadow-[0_0_8px_rgba(220,38,38,0.7)] shrink-0" />
        ...
        {/* Section Links */}
        <nav className="hidden md:flex items-center gap-4 lg:gap-6 text-xs uppercase tracking-wider font-mono text-neutral-600 dark:text-neutral-400">
